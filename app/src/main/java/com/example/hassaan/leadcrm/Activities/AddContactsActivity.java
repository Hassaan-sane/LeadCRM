...
public class AddContactsActivity extends AppCompatActivity implements View.OnClickListener,DatePickerDialog.OnDateSetListener{
    ...
    private void createReferences(){
        et_assistant_contacts=findViewById(R.id.et_assistant_contacts);
        et_contactOwner_contacts=findViewById(R.id.et_contactOwner_contact);
        et_firstName_contacts=findViewById(R.id.et_firstName_contacts);
        et_lastName_contacts=findViewById(R.id.et_lastName_contacts);
        et_email_contacts=findViewById(R.id.et_email_contacts);
        et_title_contacts=findViewById(R.id.et_title_contacts);
        et_department_contacts=findViewById(R.id.et_department_contacts);
        et_phone_contacts=findViewById(R.id.et_phone_contacts);
        et_homePhone_contacts=findViewById(R.id.et_homePhone_contacts);
        et_otherPhone_contacts=findViewById(R.id.et_otherPhone_contacts);
        et_fax_contacts=findViewById(R.id.et_assistant_contacts);
        et_mobile_contacts=findViewById(R.id.et_assistant_contacts);
        et_asstPhone_contacts=findViewById(R.id.et_assistant_contacts);
        et_reportsTo_contacts=findViewById(R.id.et_assistant_contacts);
        et_skypeId_contacts=findViewById(R.id.et_assistant_contacts);
        et_secondaryEmail_contacts=findViewById(R.id.et_assistant_contacts);
        et_twitter_contacts=findViewById(R.id.et_assistant_contacts);
        et_codeBilling_contacts = findViewById(R.id.et_codeBilling_contacts );
        et_codeShipping_contacts = findViewById(R.id.et_codeShipping_contacts );
        et_countryBilling_contacts = findViewById(R.id.et_countryBilling_contacts );
        et_countryShipping_contacts = findViewById(R.id.et_countryShipping_contacts );
        et_streetBilling_contacts = findViewById(R.id.et_streetBilling_contacts );
        et_streetShipping_contacts = findViewById(R.id.et_streetShipping_contacts );
        et_cityBilling_contacts = findViewById(R.id.et_cityBilling_contacts );
        et_cityShipping_contacts = findViewById(R.id.et_cityShipping_contacts );
        et_stateBilling_contacts = findViewById(R.id.et_stateBilling_contacts );
        et_stateShipping_contacts = findViewById(R.id.et_stateShipping_contacts );
        et_description_contacts = findViewById(R.id.et_description_contacts );

        bt_leadSource_contacts=findViewById(R.id.bt_leadSource_contacts);
        bt_accountName_contacts=findViewById(R.id.bt_accountName_contacts);
        bt_dob_contacts=findViewById(R.id.bt_dob_contacts);
        bt_salutation_contacts=findViewById(R.id.bt_salutation_contacts);

        switch_emailOptOut_contacts=findViewById(R.id.switch_emailOpt_contacts);
