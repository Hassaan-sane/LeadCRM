 ...
 * {@link ContactRelatedFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ContactRelatedFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ContactRelatedFragment extends Fragment {
    ...
    Button btn_add_note_contact, btn_add_task_contact, btn_add_attachment_contact;
     ...
     * @return A new instance of fragment ContactRelatedFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ContactRelatedFragment newInstance(String param1, String param2) {
        ContactRelatedFragment fragment = new ContactRelatedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_contact_related, container, false);

        NoteRepo noteRepo= new NoteRepo();
        btn_add_note_contact = view.findViewById(R.id.btn_add_note_contact);
        btn_add_attachment_contact = view.findViewById(R.id.btn_add_attachment_contact);
        btn_add_task_contact = view.findViewById(R.id.btn_add_task_contact);
